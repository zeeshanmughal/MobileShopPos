    ...
    <div class="card">
        <div class="card-body">
            ...
            @foreach($categories as $category)
                <li class="list-group-item d-flex justify-content-between align-items-center">{{ $category->name }} - <a href="{{ route('categories.edit', $category->id) }}" class="btn btn-info btn-sm">Edit</a> |
