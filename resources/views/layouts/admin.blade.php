...
<html lang="en" class="light-style layout-menu-fixed layout-compact" {{-- dir="ltr"
  ...
  data-template="vertical-menu-template-free"> --}}
    @include('admin.partials.head') <body>
<!-- Layout wrapper -->
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            <div class="app-brand demo">
                <a href="{{ route('admin.dashboard') }}" class="app-brand-link">
                    ...
                    <span class="app-brand-text  menu-text fw-bold ms-2">Mobile Shop POS</span>
                </a>
            ...
            <li class="menu-item @if(Request::is('*payment-plans*')) active @endif">
              <a href="{{ route('paymentPlans') }}"
                 class="menu-link">
                  <i class="menu-icon tf-icons bx bx-receipt"></i>
                  <div data-i18n="Payment Plans">Payment Plans</div>
                  {{-- <div class="badge bg-label-primary fs-tiny rounded-pill ms-auto">Pro</div> --}}
              </a>
          </li>
